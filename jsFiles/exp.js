...
var textNew = {
    ...
    Your participation will take approximately 6 minutes. 
    ...
    <p><b>Payment</b><br>
    You will receive $1.00 payment for your participation. You'll receive an additional bonus based on your performance in the experiment.  
...
function calculateUniformity(arr) {
  const counts = {};
  arr.forEach(val => counts[val] = (counts[val] || 0) + 1);
  const maxCount = Math.max(...Object.values(counts));
  return 1 - (maxCount / arr.length);
}
